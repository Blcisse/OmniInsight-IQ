...
export function useAIInsightsStore() {
  return useDashboardStore(
    (state) => ({
      ...
      clusterDistribution: state.clusterDistribution,
      selectedCluster: state.selectedCluster,
      anomalies: state.anomalies,
      anomalySummary: state.anomalySummary,
      forecasts: state.forecasts,
      selectedForecast: state.selectedForecast,
      recommendations: state.recommendations,
      ...
      fetchClusterDistribution: state.fetchClusterDistribution,
      fetchClusterInsights: state.fetchClusterInsights,
      setSelectedCluster: state.setSelectedCluster,
      fetchAnomalies: state.fetchAnomalies,
      fetchAnomalySummary: state.fetchAnomalySummary,
      detectSalesAnomalies: state.detectSalesAnomalies,
      fetchForecast: state.fetchForecast,
      fetchModelForecast: state.fetchModelForecast,
      setSelectedForecast: state.setSelectedForecast,
      fetchRecommendations: state.fetchRecommendations,
      fetchModelRecommendations: state.fetchModelRecommendations,
      setCurrentDataset: state.setCurrentDataset,
      refreshAIInsights: state.refreshAIInsights,
